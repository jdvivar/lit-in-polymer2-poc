 ...
 * @param {Object} obj
 * @returns {Array}
 */function getPrototypeChain(obj){const chain=[];let proto=obj;while(proto){chain.push(proto);proto=Object.getPrototypeOf(proto)}return chain}/**
 * @param {function()} mixin
 * @param {function()} superClass
 * @returns {boolean}
 */function wasApplied(mixin,superClass){const classes=getPrototypeChain(superClass);return classes.reduce((res,klass)=>res||appliedClassMixins.get(klass)===mixin,!1)}/**
 * # dedupeMixin
 *
 ...
 */export function dedupeMixin(mixin){return superClass=>{if(wasApplied(mixin,superClass)){return superClass}const mixedClass=mixin(superClass);appliedClassMixins.set(mixedClass,mixin);return mixedClass}}