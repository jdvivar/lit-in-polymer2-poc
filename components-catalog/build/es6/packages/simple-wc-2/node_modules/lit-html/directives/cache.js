 ...
 */import{TemplateInstance}from"../lib/template-instance.js";import{directive,NodePart,reparentNodes,TemplateResult}from"../lit-html.js";const templateCaches=new WeakMap;/**
 ...
 * `
 * ```
 */export const cache=directive(value=>part=>{if(!(part instanceof NodePart)){throw new Error("cache can only be used in text bindings")}let templateCache=templateCaches.get(part);if(templateCache===void 0){templateCache=new WeakMap;templateCaches.set(part,templateCache)}const previousValue=part.value;// First, can we update the current TemplateInstance, or do we need to move
...
part.value=cachedTemplate.instance}}part.setValue(value)});//# sourceMappingURL=cache.js.map