define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.dedupeMixin=dedupeMixin;var appliedClassMixins=new WeakMap;/**
 * @param {Object} obj
 * @returns {Array}
 */function getPrototypeChain(obj){var chain=[],proto=obj;while(proto){chain.push(proto);proto=Object.getPrototypeOf(proto)}return chain}/**
 * @param {function()} mixin
 * @param {function()} superClass
 * @returns {boolean}
 */function wasApplied(mixin,superClass){var classes=getPrototypeChain(superClass);return classes.reduce(function(res,klass){return res||appliedClassMixins.get(klass)===mixin},!1)}/**
 * # dedupeMixin
 *
 ...
 */function dedupeMixin(mixin){return function(superClass){if(wasApplied(mixin,superClass)){return superClass}var mixedClass=mixin(superClass);appliedClassMixins.set(mixedClass,mixin);return mixedClass}}});